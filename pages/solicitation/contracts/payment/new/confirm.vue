        ...
        <div class="headline-change">
          ...
          <div class="headline-change__change-link">
            <nuxt-link
              ...
              class="tracking"
              :to="{ path: '/solicitation/contracts/payment/new/' }"
            >
              {{ $t('common.change') }}
            </nuxt-link>
          </div>
  ...
  beforeRouteEnter(to, from, next) {
    ...
    if (checkReload) {
      return next((vm) => {
        ...
        vm.$router.push('/solicitation/contracts/payment/new/');
      });
    }

    if (from.name !== 'solicitation-contracts-payment-new' && !checkReload) {
      return next((vm) => {
